 ...
 * Author: Extensionly
 * Author URI:  http://www.extensionly.com/
 * Description: Allow users to add a new card for later use without ordering first. Requires WooCommerce Stripe Plugin
 * Version: 1.0
 * Copyright: © 2015 Extensionly.
